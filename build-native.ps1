...
if ($Validate) {
    ...
    [ordered]@{
        ...
        tests=@($gpuTests + @('pre-existing graphics objects','graphics state replay','ClearState pipeline preservation','idle camera inspection scheduling','large barrier batches and changing camera frames','exact DLL smoke',
