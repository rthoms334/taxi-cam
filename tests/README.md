...
- `tests/diagnostics/benchmark_compare_test.ps1`: bridge-log parser fixtures and the 0.9.8 versus `feature/performance-improvements` hot-path identity check. See [version benchmark](../docs/version-benchmark.md). Isolated Windows timings and live MSFS FPS are separate.
