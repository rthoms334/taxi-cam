...
A static ranking of observer, hook, capture and composition costs is in the [performance audit](performance-audit.md). Those findings are code-path conclusions; they do not replace the live TAXI off/on timings below.
