...
| Inno Setup Simplified Chinese message file | Build-time wizard messages for `installer/taxi-cam.iss`; downloaded to the ignored dependency cache and copied into the compiler's `Languages` folder, never installed | [Upstream file and its maintainer header](https://github.com/jrsoftware/issrc/blob/6ef32198ef1f7b7b375cd4b6b90896c2a58eb4c2/Files/Languages/ChineseSimplified.isl) |
